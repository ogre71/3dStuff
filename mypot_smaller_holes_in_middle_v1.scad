        ...
        type						    = "rod";//"bolt";//[nut,bolt,rod,washer]
...
difference() {     
    union() { 
        ...
        translate([-outerPadxy/ 2 + radius , -outerPadxy/2 + radius , 0])
            cylinder(h=padHeight, r=padRadius, center=false, $fn = fn);
        translate([outerPadxy/ 2 - radius, -outerPadxy/2+ radius, 0])
            cylinder(h=padHeight, r=padRadius, center=false, $fn = fn);
        translate([-outerPadxy / 2 + radius, outerPadxy/2 - radius, 0])
            cylinder(h=padHeight, r=padRadius, center=false, $fn = fn);
...
//            cylinder(h=12, r=5, center=true, $fn = fn);
        ...
        //Inner Holes
        translate([-20 / 2 + radius , -20/2 + radius , 0])
            cylinder(h=12, r=5/2, center=true, $fn = fn);
        translate([20 / 2 - radius, -20/2 + radius, 0])
            cylinder(h=12, r=5/2, center=true, $fn = fn);
        translate([-20 / 2 + radius, 20/2 - radius, 0])
